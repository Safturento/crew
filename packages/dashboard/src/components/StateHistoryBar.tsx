        ...
        return (
          <span key={`${t.ts}-${idx}`} className="flex items-center gap-1.5">
            ...
            <button
              ...
              className={`inline-flex h-[22px] items-center rounded-full border ${classes.border30} ${classes.bg10} ${classes.text} px-2 font-mono text-[11px] leading-none whitespace-nowrap transition-opacity hover:opacity-80`}
            >
              {meta.label}
            </button>
          </span>
