 ...
 * Awilix scope and returns its alphabetized list. Response is validated
 * by the Zod serializer compiler so a divergent shape fails loudly in
 * tests rather than at the dashboard.
 */
